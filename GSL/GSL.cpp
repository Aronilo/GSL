...
// GSL.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGSLApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CGSLApp::OnAppAbout)
...
CGSLApp::CGSLApp() noexcept
{
	...
	SetAppID(_T("GSL.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CGSLApp

CGSLApp theApp;


// Инициализация CGSLApp

BOOL CGSLApp::InitInstance()
{
