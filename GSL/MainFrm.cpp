...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CMyTreeView), CSize(rect.Width() / 4, 0), pContext);
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CGSLView), CSize(0, 0), pContext);

	SetActiveView((CView*)m_wndSplitter.GetPane(0, 1));
	CGSLDoc* pDoc = (CGSLDoc*)GetActiveDocument();
